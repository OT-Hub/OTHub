...
namespace OTHub.BackendSync.Blockchain.Web3Helper
{
    public class CustomRpcClient : ClientBase
    {
        ...
        private readonly Dictionary<Web3RpcEndpoint, RpcHttpClientManager> _httpManagerDictionary =
            new Dictionary<Web3RpcEndpoint, RpcHttpClientManager>();
        ...
        public CustomRpcClient(Web3RpcEndpoint[] endpoints, EndpointDelegate getEndpointDelegate,
            EndpointToTryOnFailureDelegate endpointToTryOnFailureDelegate,
            ...
            ILog log = null)
        {
            ...
            {
                _httpManagerDictionary[web3RpcEndpoint] =
                    new RpcHttpClientManager(httpClientHandler, null, web3RpcEndpoint.Url);
            }
        }
        ...
        {
            {
                ...
                if (rpcResponseMessage?.HasError ?? false)
                {
                    history.Success = false;
                }
